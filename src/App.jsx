...
// --- PAINEL PROFISSIONAL ---
const ProDashboard = ({ user, appointments, onUpdateStatus, onLogout, onUpdateProfile }) => {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const API_BASE_URL = import.meta.env.VITE_API_URL || 'http://salaogital.onrender.com';
